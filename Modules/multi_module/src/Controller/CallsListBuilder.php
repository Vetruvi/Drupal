...
class CallsListBuilder extends EntityListBuilder {
  ...
  public function render() {
    $build['description'] = [
      '#markup' => $this->t('Таблица со всеми со всеми созданными представлениями. Вы ими можете управлять на <a href="@adminlink">странице администратора</a>.', [
        '@adminlink' => $this->urlGenerator->generateFromRoute('multi_module.calls_settings'),
      ]),
    ];
  ...
  public function buildRow(EntityInterface $entity) {
    /* @var $entity \Drupal\multi-module\Entity\Calls */
    ...
    $config2 = \Drupal::config('multi-module.settings');
