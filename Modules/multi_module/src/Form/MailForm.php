...
class MailForm extends ConfigFormBase {
  ...
  public function buildForm(array $form, FormStateInterface $form_state) {
    ...
    $form['mail_id'] = array(
      '#type' => 'textfield',
      '#title' => $this->t('Номер блока для отправки'),
    ...
    $form['mail_bot_id']= array(
      ...
      '#title' => $this->t('Идентификатор WhatsApp бота, от которого нужно отправить сообщение'),
    ...
    $form['actions']['submit2'] = [
      '#type' => 'submit',
      '#value' => $this->t('Отправить сообщение по шаблону'),
      "#weight" => 2,
  ...
  {
    $form_state->setRedirect('multi_module.mail_content');
  ...
  {
    $form_state->setRedirect('multi_module.Csv');
    parent::submitForm($form, $form_state);
  }
